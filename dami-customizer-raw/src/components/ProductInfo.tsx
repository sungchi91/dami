...
const MOTIF_GROUPS: { group: string; motifs: MotifDef[] }[] = [
  ...
  { group: 'Floral', motifs: [
    { label: 'Aster',            baseName: 'motif_aster',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Carnation',        baseName: 'motif_carnation',        sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Cherry Blossom',   baseName: 'motif_cherryBlossom',    sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Chrysanthemum',    baseName: 'motif_chrysanthemum',    sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Clover',           baseName: 'motif_clover',           sizes: ['0p80','1','1p20','1p40'], noSuffix: true },
    { label: 'Cosmos',           baseName: 'motif_cosmos',           sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Daffodil',         baseName: 'motif_daffodil',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Daisy',            baseName: 'motif_daisy',            sizes: ['0p80','1','1p25','1p50','1p75','2','2p25','2p50','2p75','3'], noSuffix: true },
    { label: 'Daisy II',         baseName: 'motif_daisy_2',          sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Delphinium',       baseName: 'motif_delphinium',       sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Gladiolus',        baseName: 'motif_gladiolus',        sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Hawthorn',         baseName: 'motif_hawthorn',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Holly',            baseName: 'motif_holly',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Honeysuckle',      baseName: 'motif_honeysuckle',      sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Iris',             baseName: 'motif_iris',             sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Lily of the Valley', baseName: 'motif_lilyOfTheValley', sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Marigold',         baseName: 'motif_marigold',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Morning Glory',    baseName: 'motif_morningGlory',     sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Narcissus',        baseName: 'motif_narcissus',        sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Peony',            baseName: 'motif_peony',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Poppy',            baseName: 'motif_poppy',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Primrose',         baseName: 'motif_primrose',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Rose',             baseName: 'motif_rose_2',           sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    ...
    { label: 'Snowdrop',         baseName: 'motif_snowdrop',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Sweet Pea',        baseName: 'motif_sweetPea',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Tulip',            baseName: 'motif_tulip',            sizes: ['1p50','2','3','4','5','6','7'], noSuffix: true },
    { label: 'Tulip II',         baseName: 'motif_tulip_2',          sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Violet',           baseName: 'motif_violet',           sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'], noSuffix: true },
    { label: 'Water Lily',       baseName: 'motif_waterLily',        sizes: ['0p89','0p98','1p16','1p32','1p48','1p65'], noSuffix: true },
  ]},
  { group: 'Travel', motifs: [
