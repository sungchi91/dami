...
function motifUrl(motif: { baseName: string; sizes: string[] }): string {
  return `${CDN}${motif.baseName}.png${CB}`
}
...
const MOTIF_GROUPS: { group: string; motifs: MotifDef[] }[] = [
  { group: 'Drinks', motifs: [
    { label: 'Aperol Spritz',    baseName: 'motif_aperolSpritz_1p57',    sizes: ['1p57','1p97'] },
    { label: 'Champagne',        baseName: 'motif_champagne_1p5',        sizes: ['1p5','2','2p5'] },
    { label: 'Champagne Flutes', baseName: 'motif_champagneFlutes',      sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Espresso Martini', baseName: 'motif_espressoMartini_1p57', sizes: ['1p57','1p97'] },
    { label: 'Gin & Tonic',      baseName: 'motif_ginAndTonic_1p57',     sizes: ['1p57','1p97'] },
    { label: 'Iced Coffee',      baseName: 'motif_icedCoffee',           sizes: ['1p57','1p97','2p36'] },
    { label: 'Martini',          baseName: 'motif_martini_1p5',          sizes: ['1p5','2','2p5'] },
    { label: 'Spicy Marg',       baseName: 'motif_spicyMarg_1',          sizes: ['1'] },
    { label: 'Tequila',          baseName: 'motif_tequila_1',            sizes: ['1'] },
    { label: 'Whiskey Glass',    baseName: 'motif_whiskeyGlass',         sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Bottle & Glass',   baseName: 'motif_bottleAndGlass',       sizes: ['1p57','1p97','2p36'] },
    { label: 'Wine Bottle',      baseName: 'motif_wineBottle',           sizes: ['1p57','1p97','2p36'] },
    { label: 'Wine Glass',       baseName: 'motif_wineGlass_795f95a1-b3fe-4cdb-9b7d-e13db09b8f1a', sizes: ['0p79','1p18','1p57','1p97'] },
  ]},
  { group: 'Food', motifs: [
    { label: 'Cherries',         baseName: 'motif_cherries',         sizes: ['1p18','1p57','1p97'] },
    { label: 'Chili Pepper',     baseName: 'motif_chiliPepper',      sizes: ['1p25','1p5','1p75','2','2p25','2p5','2p75','3','3p25','3p5'] },
    { label: 'Crab',             baseName: 'motif_crab_1',           sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Croissant',        baseName: 'motif_croissant',        sizes: ['0p75'] },
    { label: 'French Fries',     baseName: 'motif_frenchFries',      sizes: ['1','1p5','2'] },
    { label: 'Hamburger',        baseName: 'motif_hamburger_1',      sizes: ['1','1p5','2'] },
    { label: 'Hot Dog',          baseName: 'motif_hotDog_1',         sizes: ['1','1p5','2'] },
    { label: 'Ice Cream Cone',   baseName: 'motif_iceCreamCone',     sizes: ['1p57','1p97','2p36'] },
    { label: 'Lemons',           baseName: 'motif_lemons_1',         sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Lobster',          baseName: 'motif_lobster_1',        sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Olive Branch',     baseName: 'motif_oliveBranch_1',    sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Olive Oil',        baseName: 'motif_oliveOil_1',       sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Olive Pick',       baseName: 'motif_olivePick_1',      sizes: ['1','1p5','2'] },
    { label: 'Olives',           baseName: 'motif_olives',           sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Oysters',          baseName: 'motif_oysters_1',        sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Pizza',            baseName: 'motif_pizza_1',          sizes: ['1','1p5','2'] },
    { label: 'Sardines',         baseName: 'motif_sardines_1',       sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Taco',             baseName: 'motif_taco_1',           sizes: ['1','1p5','2'] },
    { label: 'Tomatoes',         baseName: 'motif_tomatoes_1',       sizes: ['1','1p5','2','2p5','3'] },
  ]},
  { group: 'Beauty', motifs: [
    { label: 'Brush',            baseName: 'motif_brush_1p4',            sizes: ['1p4','1p6','2'] },
    { label: 'Cream',            baseName: 'motif_cream_1',              sizes: ['1','1p2','1p6'] },
    { label: 'Eye Shadow',       baseName: 'motif_eyeShadow_1p2',        sizes: ['1p2','1p4','1p8'] },
    { label: 'Eyelash Curler',   baseName: 'motif_eyelashCurler_1p2',    sizes: ['1p2','1p4','1p8'] },
    { label: 'Face Mask',        baseName: 'motif_faceMask_1p4',         sizes: ['1p4','1p6','2'] },
    { label: 'Facial Massager',  baseName: 'motif_facialMassager_1p4',   sizes: ['1p4','1p6','2'] },
    { label: 'Gua Sha',          baseName: 'motif_guaSha_1',             sizes: ['1','1p2','1p6'] },
    { label: 'Hand Cream',       baseName: 'motif_handCream_1p4',        sizes: ['1p4','1p6','2'] },
    { label: 'Lip Gloss',        baseName: 'motif_lipGloss_1p4',         sizes: ['1p4','1p6','2'] },
    { label: 'Lips',             baseName: 'motif_lips',                 sizes: ['1p80','2p80','3p80'] },
    { label: 'Lipstick',         baseName: 'motif_lipstick_1p2',         sizes: ['1p2','1p4','1p8'] },
    { label: 'Mirror',           baseName: 'motif_mirror_1p2',           sizes: ['1p2','1p4','1p8'] },
    { label: 'Perfume',          baseName: 'motif_perfume_1p2',          sizes: ['1p2','1p4','1p8'] },
    { label: 'Perfume (Clean)',  baseName: 'motif_perfumeClean_1p2',     sizes: ['1p2','1p4','1p8'] },
    { label: 'Red Lipstick',     baseName: 'motif_redLipstick_1',        sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Serum',            baseName: 'motif_serum_1p4',            sizes: ['1p4','1p6','2'] },
    { label: 'Vintage Perfume',  baseName: 'motif_vintagePerfume_1',     sizes: ['1','1p5','2','2p5','3'] },
  ]},
  { group: 'Fashion', motifs: [
    { label: 'Key',               baseName: 'motif_key',                  sizes: ['1p10','1p26','1p46','1p73','1p97','2p24','2p60','2p99','3p39','3p82','4p21'] },
    { label: 'Ballet',           baseName: 'motif_ballet',               sizes: ['1p06','1p22','1p42','1p61','1p81','2p01','2p28','2p56','2p80','3p15','3p70'] },
    { label: 'Bikini',            baseName: 'motif_bikini',               sizes: ['2','3','4','5'] },
    { label: 'Bow',              baseName: 'motif_bow',                  sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Double Bow',      baseName: 'motif_bow_0p94',             sizes: ['0p94','1p10','1p46','1p73','1p97'] },
    { label: 'Cowboy Boot',      baseName: 'motif_cowboyBoot',           sizes: ['0p96','1p80','2p80'] },
    { label: 'Flat Hair Clip',   baseName: 'motif_flatHairClip_1p4',     sizes: ['1p4','1p6','2'] },
    { label: 'Hair Clip',        baseName: 'motif_hairClip_1p2',         sizes: ['1p2','1p4','1p8'] },
    { label: 'Hair Comb',        baseName: 'motif_hairComb_1p2',         sizes: ['1p2','1p4','1p8'] },
    { label: 'Handbag',          baseName: 'motif_handbag_1',            sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Heel',             baseName: 'motif_heel_1',               sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Neat Bow',         baseName: 'motif_neatBow',              sizes: ['0p5','1','1p5','2','2p5','3'] },
    { label: 'Scarf',            baseName: 'motif_scarf_1',              sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Scrunchie',        baseName: 'motif_scrunchie_1p2',        sizes: ['1p2','1p4','1p8'] },
    { label: 'Sunglasses',       baseName: 'motif_sunglasses_1',         sizes: ['1','1p5','2','2p5','3'] },
  ]},
  { group: 'Floral', motifs: [
    { label: 'Aster',            baseName: 'motif_aster',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Carnation',        baseName: 'motif_carnation',        sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Cherry Blossom',   baseName: 'motif_cherryBlossom',    sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Chrysanthemum',    baseName: 'motif_chrysanthemum',    sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Clover',           baseName: 'motif_clover',           sizes: ['0p80','1','1p20','1p40'] },
    { label: 'Cosmos',           baseName: 'motif_cosmos',           sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Daffodil',         baseName: 'motif_daffodil',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Daisy',            baseName: 'motif_daisy',            sizes: ['0p80','1','1p25','1p50','1p75','2','2p25','2p50','2p75','3'] },
    { label: 'Daisy II',         baseName: 'motif_daisy_2',          sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Delphinium',       baseName: 'motif_delphinium',       sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Gladiolus',        baseName: 'motif_gladiolus',        sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Hawthorn',         baseName: 'motif_hawthorn',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Holly',            baseName: 'motif_holly',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Honeysuckle',      baseName: 'motif_honeysuckle',      sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Iris',             baseName: 'motif_iris',             sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Lily of the Valley', baseName: 'motif_lilyOfTheValley', sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Marigold',         baseName: 'motif_marigold',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Morning Glory',    baseName: 'motif_morningGlory',     sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Narcissus',        baseName: 'motif_narcissus',        sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Peony',            baseName: 'motif_peony',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Poppy',            baseName: 'motif_poppy',            sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Primrose',         baseName: 'motif_primrose',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Rose',             baseName: 'motif_rose_2',           sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Rose (Red)',        baseName: 'motif_roseRed',          sizes: ['1p18','1p42','1p65','1p89','2p17','2p48','2p87','3p31'] },
    { label: 'Rose (White)',      baseName: 'motif_roseWhite',        sizes: ['1p18','1p42','1p65','1p89','2p17','2p48','2p87','3p31'] },
    { label: 'Snowdrop',         baseName: 'motif_snowdrop',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Sweet Pea',        baseName: 'motif_sweetPea',         sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Tulip',            baseName: 'motif_tulip',            sizes: ['1p50','2','3','4','5','6','7'] },
    { label: 'Tulip II',         baseName: 'motif_tulip_2',          sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Violet',           baseName: 'motif_violet',           sizes: ['1p01','1p21','1p41','1p61','1p81','2p01'] },
    { label: 'Water Lily',       baseName: 'motif_waterLily',        sizes: ['0p89','0p98','1p16','1p32','1p48','1p65'] },
  ]},
  { group: 'Travel', motifs: [
    { label: 'Airplane',         baseName: 'motif_airplane',         sizes: ['1p38','1p77','2p17'] },
    { label: 'Anchor',           baseName: 'motif_anchor',           sizes: ['1p18','1p57','1p97'] },
    { label: 'Passport',         baseName: 'motif_passport',         sizes: ['1p57','1p97','2p36'] },
    { label: 'Sailboat',         baseName: 'motif_sailboat',         sizes: ['1p18','1p57','1p97'] },
    { label: 'Suitcase',         baseName: 'motif_suitcase',         sizes: ['1p77','2p17','2p56'] },
  ]},
  { group: 'Fun & Games', motifs: [
    { label: 'Match Box',        baseName: 'motif_matchBox',         sizes: ['1','1p5','2','2p5','3'] },
    { label: '8 Ball',           baseName: 'motif_8ball',            sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Dice',             baseName: 'motif_dice',             sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Horseshoe',        baseName: 'motif_horseshoe',        sizes: ['0p39','0p59','0p79','0p98','1p18','1p38','1p57','1p77','1p97','2p17','2p36','2p76'] },
    { label: 'Lucky 777',        baseName: 'motif_lucky777',         sizes: ['2','3','4','5'] },
    { label: 'Lucky Dice',       baseName: 'motif_luckyDice',        sizes: ['2','3','4','5'] },
    { label: 'Lucky Heart',      baseName: 'motif_luckyHeart',       sizes: ['0p75','1','2','3','4','5'] },
    { label: 'Playing Cards',    baseName: 'motif_playingCards',     sizes: ['1','1p5','2','2p5','3'] },
  ]},
  { group: 'Golf', motifs: [
    { label: 'Crossing Tees',    baseName: 'motif_crossingTees',     sizes: ['1','1p5','2','2p5'] },
    { label: 'Golf Cart',        baseName: 'motif_golfCart_1',       sizes: ['1','1p5','2','2p5'] },
    { label: 'Golf Club Bag',    baseName: 'motif_golfClubBag_1',    sizes: ['1','1p5','2','2p5'] },
    { label: 'Golf Flag',        baseName: 'motif_golfFlag_1',       sizes: ['1','1p5','2','2p5'] },
    { label: 'Golf Map',         baseName: 'motif_golfMap',          sizes: ['1','1p5','2','2p5'] },
    { label: 'Green Jacket',     baseName: 'motif_greenJacket',      sizes: ['1','1p5','2','2p5'] },
    { label: 'Tee Time',         baseName: 'motif_teeTime',          sizes: ['1','1p5','2','2p5'] },
  ]},
  { group: 'NYC', motifs: [
    { label: 'NYC Apple',        baseName: 'motif_nycApple_1p25',    sizes: ['1p25','1p75','2p25'] },
    { label: 'NYC Crown',        baseName: 'motif_nycCrown_1',       sizes: ['1','1p5','2'] },
    { label: 'NYC Empire',       baseName: 'motif_nycEmpire_1p5',    sizes: ['1p5','2','2p5'] },
    { label: 'NYC Taxi',         baseName: 'motif_nycTaxi_1p5',      sizes: ['1p5','2','2p5'] },
  ]},
  { group: 'I♥SF', motifs: [
    { label: 'Cable Car',        baseName: 'motif_cableCar',         sizes: ['1p50','2','2p50'] },
    { label: 'Victorian Row',    baseName: 'motif_victorianRow',     sizes: ['1p25','1p75','2p25'] },
  ]},
  { group: 'Bachelorette', motifs: [
    { label: 'Wedding Rings',    baseName: 'motif_weddingRings',         sizes: ['0p96','1p42','1p91'] },
    { label: 'Locket',           baseName: 'motif_locketFrame',          sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Balloon',          baseName: 'motif_bacheloretteBalloon',  sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Bands',            baseName: 'motif_bacheloretteBands',    sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Boots',            baseName: 'motif_bacheloretteBoots',    sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Bow',              baseName: 'motif_bacheloretteBow',      sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Bucket',           baseName: 'motif_bacheloretteBucket',   sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Cake',             baseName: 'motif_bacheloretteCake',     sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Card',             baseName: 'motif_bacheloretteCard',     sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Dice',             baseName: 'motif_bacheloretteDice',     sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Disco',            baseName: 'motif_bacheloretteDisco',    sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Hat',              baseName: 'motif_bacheloretteHat',      sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Lips',             baseName: 'motif_bacheloretteLips',     sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Lipstick',         baseName: 'motif_bacheloretteLipstick', sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Long Bow',         baseName: 'motif_bacheloretteLongBow',  sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Sunnies',          baseName: 'motif_bacheloretteSunnies',  sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Tower',            baseName: 'motif_bacheloretteTower',    sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Vinyl',            baseName: 'motif_bacheloretteVinyl',    sizes: ['1p50','2','2p50','3','4'] },
    { label: 'Wine',             baseName: 'motif_bacheloretteWine',     sizes: ['1p50','2','2p50','3','4'] },
  ]},
  { group: 'Sentimental', motifs: [
    { label: 'Coquette',         baseName: 'motif_locketCoquette',   sizes: ['2','3','4','5','6','7','8'] },
    { label: 'Coquette 2',       baseName: 'motif_locketCoquette2',  sizes: ['2','2p50','3','3p50','4','4p50','5','5p50','6','6p50','7'] },
    { label: 'Heart 2',          baseName: 'motif_locketHeart2',     sizes: ['2','2p50','3','3p50','4','4p50','5','5p50','6','6p50'] },
    { label: 'Heart 3',          baseName: 'motif_locketHeart3',     sizes: ['2','2p50','3','3p50','4','4p50','5','5p50','6'] },
  ]},
  { group: 'Animals', motifs: [
    { label: 'Bichon Frise',     baseName: 'motif_bichonFrise',      sizes: ['2p80','3p78','4p76'] },
    { label: 'Brown Dog',        baseName: 'motif_brownDog',         sizes: ['2p80','3p80','4p80'] },
    { label: 'Pomeranian',       baseName: 'motif_pomeranian_2p2',   sizes: ['2p2','2p8','3p8'] },
  ]},
  { group: 'Lifestyle', motifs: [
    { label: 'Evil Eye',         baseName: 'motif_evilEye',          sizes: ['0p83','1p22','1p62'] },
    { label: 'Heart',            baseName: 'motif_heart_0p8',        sizes: ['0p8','1','1p4'] },
    { label: 'Palm Tree',        baseName: 'motif_palmTree_1',       sizes: ['1p33','1p86'] },
    { label: 'Pennant',          baseName: 'motif_pennant',          sizes: ['1','1p25','1p5'] },
    { label: 'Pine Tree',        baseName: 'motif_pineTree',         sizes: ['1','1p5','2','2p5','3'] },
    { label: 'Smile',            baseName: 'motif_smile',            sizes: ['0p80','1','1p20'] },
    { label: 'Teddy Bear',       baseName: 'motif_teddyBear',        sizes: ['1','1p5'] },
    { label: 'Tennis Racket',    baseName: 'motif_tennisRacket',     sizes: ['2'] },
    { label: 'XOXO Heart (Red)',  baseName: 'motif_xoxoHeartRed',     sizes: ['1','1p25','1p50','1p75'] },
    { label: 'XOXO Heart (Pink)', baseName: 'motif_xoxoHeartPink',    sizes: ['1','1p25','1p50','1p75'] },
    { label: 'XOXO Heart (Green)',baseName: 'motif_xoxoHeartGreen',   sizes: ['1','1p25','1p50','1p75'] },
    { label: 'XOXO Heart (Blue)', baseName: 'motif_xoxoHeartBlue',    sizes: ['1','1p25','1p50','1p75'] },
  ]},
]
