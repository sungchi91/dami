...
export const FIXED_LAYOUTS: Record<string, ProductFixedLayouts> = {
  'Grand Tote': {
    ...
    sidenote:  { text: { x: 0.51, y: 0.18 }, motif: { x: 0.82, y: 0.83 } },
  ...
  'Signature Tote': {
    ...
    sidenote:  { text: { x: 0.49, y: 0.18 }, motif: { x: 0.83, y: 0.80 } },
  ...
  'Grand Waffle Pouch': {
    ...
    crown:     { text: { x: 0.50, y: 0.52 }, motifRow: { centerX: 0.51, y: 0.34 } },
    pedestal:  { text: { x: 0.51, y: 0.40 }, motifRow: { centerX: 0.52, y: 0.60 } },
  },
  'Seersucker Pouch': {
    classic:   { text: { x: 0.50, y: 0.50 } },
    statement: { text: { x: 0.50, y: 0.50 } },
  ...
  'Linen Cocktail Napkin': {
    classic:         { text: { x: 0.50, y: 0.52 } },
    statement:       { text: { x: 0.50, y: 0.52 } },
    sidenote:        { text: { x: 0.35, y: 0.50 }, motif: { x: 0.75, y: 0.50 } },
    crown:           { text: { x: 0.50, y: 0.20 }, motifRow: { centerX: 0.50, y: 0.80 } },
    pedestal:        { text: { x: 0.50, y: 0.80 }, motifRow: { centerX: 0.50, y: 0.20 } },
    'side-font':     { text: { x: 0.92, y: 0.86 } },
    'side-motif':    { motif: { x: 0.86, y: 0.86 } },
    'classic-motif': { motif: { x: 0.52, y: 0.52 } },
  },
  'The Oxford': {
    classic:   { text: { x: 0.50, y: 0.50 } },
    statement: { text: { x: 0.50, y: 0.50 } },
