...
exports.brandQuestions = void 0;
exports.brandQuestions = [
    {
        type: 'input',
        name: 'brandName',
        message: 'What is your brand name?',
        validate: (input) => input.trim().length > 0 || 'Brand name is required.',
    },
    {
        type: 'input',
        name: 'targetAudience',
    ...
    },
    {
        ...
        validate: (input) => input.trim().length > 0 || 'Please enter at least one adjective.',
    },
    {
        type: 'list',
        name: 'colorMood',
