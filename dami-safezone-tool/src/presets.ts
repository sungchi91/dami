export const PRESETS = [
  ...
  { name: "Waffle Pouch",          bgImage: '/images/products/pouch/small_waffle_pouch.png',                          bgColor: '#EAE4DA', widthRatio: 0.85, heightRatio: 0.33, offsetX: -0.01, offsetY:  0.01, physicalWidthInches:  7.9  },
  { name: "Grand Waffle Pouch",    bgImage: '/images/products/pouch/large_waffle_pouch.png',                           bgColor: '#EAE4DA', widthRatio: 0.84, heightRatio: 0.47, offsetX: -0.01, offsetY:  0.01, physicalWidthInches:  9    },
  ...
  { name: "Linen Cocktail Napkin", bgImage: '/images/products/napkin/napkin.PNG',                                       bgColor: '#F5F2EE', widthRatio: 0.53, heightRatio: 0.45, offsetX:  0.00, offsetY: -0.01, physicalWidthInches:  6    },
